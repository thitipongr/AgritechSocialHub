...
const FeedBox = ({ data }) => {
  ...
  return (
    <div className="rounded-lg bg-white border-2 p-4 flex flex-col">
      <div className="flex flex-row">
        ...
        <div className="ml-2">
          ...
          <div className="text-slate-400 font-light">
            <DatetoString date={postDate} />
          </div>
        </div>
      </div>
      <div className="mt-3">{postDetail}</div>
      <div className="mt-3 flex flex-row justify-between pb-4 border-b-2">
        <div className="flex flex-row">
          <svg
          ...
          <ShortnessNum num={like} />
        </div>
        <div className="flex flex-row">
          <ShortnessNum num={share} />
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <div className=" flex flex-row justify-around p-2 border-b-2">
        <button className="flex flex-row w-full mr-2 justify-center p-3 rounded-lg hover:bg-emerald-100">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <button className="flex flex-row w-full justify-center p-3 rounded-lg hover:bg-emerald-100">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
